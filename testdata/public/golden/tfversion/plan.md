...
|---|---|---|---|---|
| `renovate/alpine` | alpine  →  | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
...
| `renovate/argoproj-argo-cd-2.x` | argoproj/argo-cd v2.12.3 → v2.14.21 | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
| `renovate/argoproj-argo-cd-3.x` | argoproj/argo-cd v2.12.3 → v3.5.3 | dependencyDashboardApproval | packageRules[740] | — |
| `renovate/argoproj-argo-cd-3.x` | argoproj/argo-cd v2.12.3 → v3.5.3 | minimumReleaseAge `the release's age is unknown and minimumReleaseAgeBehaviour is not timestamp-optional` | packageRules[740] | — |
| `renovate/argoproj-argo-cd-3.x` | argoproj/argo-cd v2.12.3 → v3.5.3 | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
| `renovate/grafana-monorepo` | grafana 8.5.1 → 8.15.0 | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
| `renovate/major-grafana-monorepo` | grafana 8.5.1 → 10.5.15 | dependencyDashboardApproval | packageRules[740] | — |
| `renovate/major-grafana-monorepo` | grafana 8.5.1 → 10.5.15 | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
| `renovate/terraform-monorepo` | hashicorp/terraform 1.9.8 → 1.16.2 | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
| `renovate/terraform-monorepo` | hashicorp/terraform v1.7.0 → v1.16.2 | schedule `outside * 0,4,8,12,16,20 * * * (Europe/Berlin)` | packageRules[758] | 2026-09-14T10:00:00Z |
